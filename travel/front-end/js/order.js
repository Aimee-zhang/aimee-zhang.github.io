$(function() {
    ...
    $(".visa-add-box").on("click",".modify",function(){
        $(this).parents(".apply-people").siblings(".apply-list-box").fadeIn();

    })
    $(".visa-add-box").on("click",".delete",function(){
        $(this).parents(".visa-add-box").hide();
